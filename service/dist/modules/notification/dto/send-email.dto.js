...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'User ID for logging' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SendEmailDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user@example.com', description: 'Recipient email(s)' }),
    __metadata("design:type", Object)
], SendEmailDto.prototype, "to", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Your BoldMind Update' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Plain text body' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SendEmailDto.prototype, "text", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Custom from address' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Email tags for analytics' }),
    (0, class_validator_1.IsOptional)(),
