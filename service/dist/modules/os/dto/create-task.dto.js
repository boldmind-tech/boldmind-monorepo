...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Create a modern design for the landing page' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Assigned user ID' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'feature', description: 'Task label/type' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
