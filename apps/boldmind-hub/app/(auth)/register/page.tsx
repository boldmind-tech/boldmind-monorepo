...
/**
 * BoldMind Hub — Register Page (inner form only)
 ...
 *
 * Wired to useRegister hook → POST /auth/register.
 * Google OAuth → same window.location redirect pattern as login (no SDK needed).
 */
