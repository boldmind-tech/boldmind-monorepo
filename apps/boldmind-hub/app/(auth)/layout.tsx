...
// ─────────────────────────────────────────────────────────────────────────────
// apps/boldmind-hub/app/(auth)/layout.tsx
// ─────────────────────────────────────────────────────────────────────────────
// Central auth shell. Used by ALL auth pages across the ecosystem:
//   /login  /register  /forgot-password  /change-password  /verify-email
//
// Split layout (desktop):
//   LEFT  — dark navy branding panel with ecosystem products + stats
//   RIGHT — white/glass card containing {children} (the auth form)
//
// Features:
//   - ?return_url= with open-redirect protection (only BoldMind domains allowed)
//   - Auto-redirects already-logged-in users before render
//   - Shows which app is requesting login (return_url context banner)
