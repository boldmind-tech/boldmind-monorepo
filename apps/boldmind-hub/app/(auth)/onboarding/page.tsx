...
/**
 * BoldMind Hub — Onboarding Page
 * File: apps/boldmind-hub/app/onboarding/page.tsx
 *
 * Wired to: POST /user/onboarding (via userAPI via apiFetch).
 * Replaced raw fetch('/api/auth/complete-onboarding') with a typed call.
