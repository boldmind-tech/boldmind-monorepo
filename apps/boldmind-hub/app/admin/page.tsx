...
/**
 * BoldMind Hub — Admin Dashboard
 * File: apps/boldmind-hub/app/admin/page.tsx
 *
 * Wired to hubAPIAdapter.getDashboardStats() (already correct).
 * Fixed:
 *   - Removed `User` import from @boldmind/utils (caused type conflicts)
 *   - Role check uses authUser directly — no cast through unknown
 *   - Full-page spinner replaced with skeleton cards
 *   - Added error state with retry button
 *   - Activity list is empty-state safe
 */
