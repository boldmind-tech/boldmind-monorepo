...
/**
 * BoldMind Hub — Dashboard Layout
 * File: apps/boldmind-hub/app/dashboard/layout.tsx
 *
 * Wraps every /dashboard/* page with the responsive sidebar + mobile topbar.
 * No API calls here — purely structural.
 */
