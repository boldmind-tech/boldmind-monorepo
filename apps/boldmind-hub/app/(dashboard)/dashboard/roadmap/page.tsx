...
/**
 * BoldMind Hub — Roadmap Dashboard
 * File: apps/boldmind-hub/app/dashboard/roadmap/page.tsx
 *
 * The NestJS server does not yet expose a /hub/roadmap endpoint.
 * Static milestones are typed and centralised here so they can be swapped
 * for an API call (hubAPIAdapter.getRoadmap) in a single change when ready.
 *
 * TODO: add getRoadmap() to hub-api-adapter.ts and replace MILESTONES below.
 */
