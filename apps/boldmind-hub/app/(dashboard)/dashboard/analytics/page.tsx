...
/**
 * BoldMind Hub — Analytics Page
 * File: apps/boldmind-hub/app/dashboard/analytics/page.tsx
 *
 * Fixed: removed BOLDMIND_PRODUCTS import (package may not exist in monorepo).
 * Wired to hubAPIAdapter.getAnalyticsOverview() which derives real numbers
 * from /hub/dashboard + /admin/analytics/overview.
 * KPI cards and product table now show live data with skeleton loading.
 */
