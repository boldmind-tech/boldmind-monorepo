...
/**
 * BoldMind Hub — Products Page
 * File: apps/boldmind-hub/app/dashboard/products/page.tsx
 *
 * Wired to hubAPIAdapter.getProducts / deleteProduct.
 * Added: skeleton grid, error banner, proper filter dependency tracking.
 * Removed: full-page spinner that blocked the layout.
 */
