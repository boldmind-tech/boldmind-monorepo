...
/**
 * BoldMind Hub — Payment & Subscriptions Page
 * File: apps/boldmind-hub/app/dashboard/subscriptions/page.tsx
 *
 * Wired to useSubscriptions, useInitializePayment, useVerifyPayment hooks.
