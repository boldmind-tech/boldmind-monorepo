...
/**
 * BoldMind Hub — Features Page
 * File: apps/boldmind-hub/app/dashboard/features/page.tsx
 *
 * Wired to useHubProducts, useDashboardStats, useAdminAnalytics hooks.
 * Real data replaces the hardcoded BOLDMIND_PRODUCTS / calculateTotalMonthlyRevenue imports.
 */
