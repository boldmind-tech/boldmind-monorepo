...
/**
 * BoldMind Hub — Revenue Dashboard
 * File: apps/boldmind-hub/app/dashboard/revenue/page.tsx
 *
 * Wired to hubAPIAdapter.getRevenueAnalytics() which derives numbers from
 * /hub/dashboard. Adds skeleton loading, error state, ARR/MRR breakdown,
 * and a revenue bar visualisation without an external chart library.
 */
