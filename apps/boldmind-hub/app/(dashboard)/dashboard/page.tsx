...
/**
 * BoldMind Hub — Dashboard Page
 * File: apps/boldmind-hub/app/dashboard/page.tsx
 *
 * Wired to useDashboardStats hook. Adds skeleton loading, error states,
 * and proper TypeScript types throughout.
 */
