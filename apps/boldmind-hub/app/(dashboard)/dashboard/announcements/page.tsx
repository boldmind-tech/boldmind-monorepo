...
/**
 * BoldMind Hub — Announcements Page
 * File: apps/boldmind-hub/app/dashboard/announcements/page.tsx
 *
 * Wired to hubAPIAdapter.getAnnouncements / createAnnouncement.
 * Removed: duplicate loading spinner, replaced with skeleton cards.
 * Fixed: form uses controlled state, not HTML form submission.
 */
