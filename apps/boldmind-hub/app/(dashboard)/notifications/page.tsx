...
/**
 * BoldMind Hub — Notifications Page
 * File: apps/boldmind-hub/app/dashboard/notifications/page.tsx
 *
 * Wired to useNotifications, useUnreadCount, useMarkRead, useMarkAllRead hooks.
 * Supports pagination, optimistic mark-read, and unread filter.
 */
