// ─────────────────────────────────────────────────────────────────────────────
// apps/boldmind-hub/app/(public)/pricing/page.tsx  [Server Component]
// ─────────────────────────────────────────────────────────────────────────────
// Pricing page for boldmind.ng/pricing
// - Server-fetches live pricing from the NestJS API
// - Falls back to static BOLDMIND_PRICING from @boldmind/utils if API unavailable
// - Layout (navbar + footer) comes from (public)/layout.tsx route group
//
// ASSUMPTION: The pricing endpoint is GET /hub/pricing or similar.
// Once you paste your registered endpoints I will update the fetch URL.
// ─────────────────────────────────────────────────────────────────────────────
