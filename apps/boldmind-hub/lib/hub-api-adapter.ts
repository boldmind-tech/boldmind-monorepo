// ─────────────────────────────────────────────────────────────────────────────
// apps/boldmind-hub/lib/hub-api-adapter.ts
//
// Maps every `hubAPIAdapter.*` call used across dashboard pages to the real
// typed API functions in lib/api.ts.
//
// Centralised here so all pages that import hubAPIAdapter get the real
// NestJS calls — no more scattered fetch() calls or missing adapters.
// ─────────────────────────────────────────────────────────────────────────────
