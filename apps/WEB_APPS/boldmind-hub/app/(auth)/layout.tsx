  ...
  >
    <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
      ...
      <p className="text-white/90 text-lg mb-4 italic">
        "BoldMind's ecosystem has transformed how I run my business. 
...
const StatsDisplay = () => (
  ...
  >
    {[
      ...
      { value: '₦95K+', label: 'Monthly Revenue' },
    ].map((stat, index) => (
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#00143C] via-[#0A1F4F] to-[#2A4A6E] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col p-12 w-full">
          ...
          <Link href="/" className="flex items-center gap-3 mb-12 group">
            <Logo size="lg" />
            <div>
              <h1 className="text-white font-black text-2xl group-hover:text-[#FFC800] transition-colors">
                BoldMind
              </h1>
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-white/70 text-lg mb-8 max-w-md">
                Join the movement to empower 1 million Nigerian entrepreneurs by 2030. 
                Access 31+ innovative products designed for your success.
              </p>
            </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white dark:bg-gray-950 relative">
        ...
        <div className="lg:hidden absolute top-6 left-6">
          <Link href="/" className="flex items-center gap-2">
            <Logo size="sm" />
            <span className="font-black text-[#00143C] dark:text-white">BoldMind</span>
          </Link>
        </div>
