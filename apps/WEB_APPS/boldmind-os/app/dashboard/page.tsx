...
export default function BoldMindOSDashboard() {
  ...
  const recentActivity = [
    {
      type: "capture",
      action: "Captured new idea",
      time: "5 min ago",
      icon: Brain,
    },
    {
      type: "focus",
      action: "Completed 25min session",
      time: "1 hour ago",
      icon: Zap,
    },
    {
    ...
    {
      type: "connect",
      action: "Added 3 new connections",
      time: "3 hours ago",
      icon: Link2,
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-3xl font-black text-[#00143C] mb-1">
                  {stat.value}
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {brains.map((brain, index) => (
              ...
              >
                ...
                <h3 className="text-2xl font-black text-[#00143C] mb-3">
                  {brain.name}
                </h3>
                ...
                <div className="flex items-center gap-6 text-sm">
                  {Object.entries(brain.stats).map(([key, value]) => (
                    <div key={key}>
                      <div className="font-black text-[#00143C] text-lg">
                        {value}
                      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-black text-[#00143C]">
                Today's Tasks
              </h2>
              ...
              {todaysTasks.map((task, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div
                      className={`font-bold ${task.completed ? "line-through text-gray-500" : "text-[#00143C]"}`}
                    >
                      {task.title}
                    </div>
          ...
          <motion.div
            ...
            className="bg-white p-8 rounded-3xl border-2 border-gray-200"
          >
            <h2 className="text-2xl font-black text-[#00143C] mb-6">
              Recent Activity
            </h2>
            ...
            <div className="space-y-6">
              {recentActivity.map((activity, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="font-bold text-[#00143C]">
                      {activity.action}
                    </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl border-2 border-blue-200">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-black text-[#00143C]">
