...
export default function Footer() {
  const footerLinks: FooterLinks = {
    ...
    'Connect': [
      { name: 'Facebook', href: 'https://facebook.com/educenter', icon: <Facebook className="h-4 w-4" /> },
      { name: 'Twitter', href: 'https://twitter.com/educenter', icon: <Twitter className="h-4 w-4" /> },
      { name: 'Instagram', href: 'https://instagram.com/educenter', icon: <Instagram className="h-4 w-4" /> },
      { name: 'LinkedIn', href: 'https://linkedin.com/company/educenter', icon: <Linkedin className="h-4 w-4" /> },
      { name: 'YouTube', href: 'https://youtube.com/educenter', icon: <Youtube className="h-4 w-4" /> },
    ],
  };
