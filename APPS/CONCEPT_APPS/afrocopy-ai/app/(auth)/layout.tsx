//APPS/WEB_APPS/AfroCopy AI-hub/app/(auth)/layout.tsx
'use client';

import { motion } from 'framer-motion';
import { Logo, SuperNavbar, SuperFooter } from '@AfroCopy AI/ui';
  ...
  >
    <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
      ...
      <p className="text-white/90 text-lg mb-4 italic">
        "AfroCopy AI's ecosystem has transformed how I run my business.
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#00143C] via-[#0A1F4F] to-[#2A4A6E] relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col p-12 w-full">
            ...
            <Link href="/" className="flex items-center gap-3 mb-12 group">
              <Logo src="/logo.png" alt="AfroCopy AI Logo" className='w-20 h-20' />
            </Link>
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              >
                ...
                <p className="text-white/70 text-lg mb-8 max-w-md">
                  Join thousands of users who trust AfroCopy AI for their needs.
                </p>
              </motion.div>
