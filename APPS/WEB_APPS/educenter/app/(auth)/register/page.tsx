...
import { registerWithEmail, loginWithOAuth, GoogleProvider } from "@boldmind/auth";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-2 mb-4">
            ...
            <span className="text-3xl font-bold text-gray-900 dark:text-white">EduCenter</span>
          </Link>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center space-x-2 border-2 border-gray-300 dark:border-gray-600 py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
