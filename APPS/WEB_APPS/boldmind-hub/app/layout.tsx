...
export const metadata: Metadata = {
  ...
  description: 'Nigerian tech ecosystem creating impact-driven products that solve fundamental problems through authentic media, education, and AI-powered technology. Empowering entrepreneurs with AmeboGist, EduCenter, PlanAI, and 28+ innovative solutions.',
  keywords: [
  ...
  openGraph: {
    ...
    siteName: 'BoldMind',
    description: 'Empowering 1 million Nigerian Entrepreneurs by 2030 through our ecosystem of 31+ innovative products including AmeboGist, EduCenter, and PlanAI.',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'The complete Nigerian tech ecosystem: AmeboGist, EduCenter, PlanAI, and 28+ more innovative products transforming business in Nigeria.',
...
const organizationSchema = {
  ...
  description: 'Empowering 1 million Nigerian Entrepreneurs by 2030 through innovative technology solutions',
  foundingDate: '2025',
  founders: [
    {
      '@type': 'Person',
      name: 'Charles Uche Chijuka',
      url: ['https://facebook.com/cuche3', 'https://linkedin.com/in/charliedotcom', 'https://twitter.com/charlesuchech']
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: {
        '@type': 'Product',
        name: 'EduCenter',
        description: 'Practical learning engine for exam mastery and digital skills',
  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      <head>
        ...
        <meta name="theme-color" content="#00143C" media="(prefers-color-scheme: light)" />
