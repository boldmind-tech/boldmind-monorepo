...
export function FinancialForecastingLayout({ children }: { children: React.ReactNode }) {
  const forceProduct = 'financial-forecasting';
  ...
  const productTheme = {
    slug: forceProduct,
    name: product?.name || 'Financial Forecasting',
