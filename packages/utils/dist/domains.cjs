...
//#endregion
exports.DOMAIN_MAPPINGS = DOMAIN_MAPPINGS;
exports.default = DOMAIN_MAPPINGS;
exports.getAPIEndpoint = getAPIEndpoint;
exports.getDomainFromProduct = getDomainFromProduct;
exports.getDomainsByStatus = getDomainsByStatus;
exports.getProductFromDomain = getProductFromDomain;
exports.isLiveDomain = isLiveDomain;
