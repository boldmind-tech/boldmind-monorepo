...
exports.SERVICE_DB_CONFIG = SERVICE_DB_CONFIG;
exports.getConnectionString = getConnectionString;
exports.getDatabaseEnvVar = getDatabaseEnvVar;
exports.getDatabaseName = getDatabaseName;
exports.getProductsForService = getProductsForService;
exports.getServiceDatabase = getServiceDatabase;
exports.getServiceForProduct = getServiceForProduct;
exports.getServiceUrl = getServiceUrl;
exports.getServiceUrlEnvVar = getServiceUrlEnvVar;
exports.getServicesByDatabase = getServicesByDatabase;
exports.usesMongoDB = usesMongoDB;
exports.usesPostgres = usesPostgres;
exports.validateDatabaseEnvVars = validateDatabaseEnvVars;
//# sourceMappingURL=database-config.cjs.map