export const PRODUCT_IDS = {
  EDUCENTER: {
    STUDY_HUB_6M: 'educenter-study-hub-6months',
    STUDY_HUB_1Y: 'educenter-study-hub-1year',
    BUSINESS_SCHOOL: 'educenter-business-school-lifetime',
    AI_LAB: 'educenter-ai-lab-lifetime',
  },
  NAIJA_FITHER: {
    BASIC: 'naija-fither-basic-monthly',
    PREMIUM: 'naija-fither-premium-monthly',
  },
  BOLDMIND_OS: {
    PRO_MONTHLY: 'boldmind-os-pro-monthly',
    PRO_YEARLY: 'boldmind-os-pro-yearly',
  },
  PLANAI: {
    RECEPTIONIST_STARTER: 'planai-receptionist-starter',
    RECEPTIONIST_BUSINESS: 'planai-receptionist-business',
    SOCIAL_FACTORY: 'planai-social-factory-basic',
  },
} as const;
